...
export class OpenPositionsComponent implements OnInit {
  ...
  loadPositions(){
    ...
    else if(localStorage.getItem('language') === 'bih')
    {
      this.positionData = require('../../assets/positionsdataBh.json');
    }
    else
    {
      this.positionData = require('../../assets/positionsdataDe.json');
    }
  }
  ...
  scrollTo()
  {
    const el: any | any = document.getElementById("positionContainer");
