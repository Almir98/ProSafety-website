...
export class PositionPageComponent implements OnInit {
  ...
  ngOnInit() {
	...
	{
		positionData = require('../../assets/positionsdataDe.json');
	...
	// replaceable ID depending on how many positions are currently available
	if(this.position?.id === 2){
		this.generalPosition = true;
	}
  }
